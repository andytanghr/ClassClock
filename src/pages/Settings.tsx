...
import { getLocalStorageBoolean } from '../utils/Helpers'
...
class Settings extends Component<{}, IndexState> {
  constructor (props: any) {
    ...
    this.state = {
      use24HourTime: getLocalStorageBoolean('use24HourTime')
    }
  }
      ...
      <div className='App'>
        ...
        <section id='credits' className='centered topSpace'>
          <a
            ...
            href='https://github.com/MoralCode/ClassClock'
          >
            View on GitHub
          </a>
          <a
            className=' topSpace'
            href='https://join.slack.com/t/classclock/shared_invite/enQtNTE0MDkyNzAwNzU3LWNhMGUwODU2ZjhkYTYxMTgzNDE1OWEyMGY2OGNiNTBhOWM5NDVhZGUzNDVlNzRiZTE3NTNmODFjYWNkNDhmMDU'
          >
            Come chat on Slack!
          </a>
          <br />
          <p id='credits' className=''>
            ...
            <br />
            <a href='https://github.com/MoralCode/ClassClock/graphs/contributors'>
              Contributors
            </a>
          </p>
        </section>
